...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2020-05-17 12:07:21',NULL),('diagnostics.include_raw','OFF','2020-05-17 12:07:21',NULL),('ps_thread_trx_info.max_length','65535','2020-05-17 12:07:21',NULL),('statement_performance_analyzer.limit','100','2020-05-17 12:07:21',NULL),('statement_performance_analyzer.view',NULL,'2020-05-17 12:07:21',NULL),('statement_truncate_len','64','2020-05-17 12:07:21',NULL);
...
-- Dump completed on 2020-05-30 21:26:56
CREATE DATABASE  IF NOT EXISTS `member_info` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `member_info`;
-- MySQL dump 10.13  Distrib 8.0.20, for Win64 (x86_64)
--
-- Host: localhost    Database: member_info
-- ------------------------------------------------------
-- Server version	8.0.20
...
--
-- Table structure for table `dolbom`
--

DROP TABLE IF EXISTS `dolbom`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `dolbom` (
...
--
-- Dumping data for table `dolbom`
--

LOCK TABLES `dolbom` WRITE;
/*!40000 ALTER TABLE `dolbom` DISABLE KEYS */;
INSERT INTO `dolbom` VALUES (1,'돌보미1','1234asdf','010-0000-0000','2020-05-13','2020-05-18','경상북도 경산시 중방동',' 중앙로 3-3','오전시간만','1일 1회이상 산책'),(2,'돌보미2','134faseerwer','010-0300-0300','2020-05-25','2020-05-30','경상북도 경산시 계양동','솔숲길 4-4','종일 가능','타 반려동물 같이있음');
/*!40000 ALTER TABLE `dolbom` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `matkim`
--

DROP TABLE IF EXISTS `matkim`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `matkim` (
  `number` int NOT NULL AUTO_INCREMENT,
  ...
  `date_start` date DEFAULT NULL,
  `date_finish` date DEFAULT NULL,
  `size_animal` varchar(30) DEFAULT NULL,
  `animal_info` text,
  `requirements` text,
  PRIMARY KEY (`number`)
...
--
-- Dumping data for table `matkim`
--

LOCK TABLES `matkim` WRITE;
/*!40000 ALTER TABLE `matkim` DISABLE KEYS */;
INSERT INTO `matkim` VALUES (1,'맡기미1','alwe--3922','010-0301-0301','2020-05-23','2020-05-26','소형견','다른 개를 무서웧마','지정된 사료 주기');
/*!40000 ALTER TABLE `matkim` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'member_info'
--

--
-- Dumping routines for database 'member_info'
--
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
